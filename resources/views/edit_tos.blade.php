            ...
            <div class="col-xl-6">
              ...
              <form action="{{route('update.persyaratan', ['persyaratan' => $data[0]->id])}}" method="POST" >
                ...
                <div class="row">
                  ...
                  <input type="text" class="form-control" placeholder="XL / Tsel / dll" name="nama_tos" value="{{$data[0]->nama_tos}}">
                  @error('nama_tos')
                ...
                <div class="row mg-t-20">
                  ...
                  <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                    ...
                    <textarea name="deskripsi" id="ckeditor" class="ckeditor">{{$data[0]->deskripsi}}</textarea>
                    @error('deskripsi')
                  <div class="text-danger">{{ $message }}</div>
                  @enderror
                  </div>
